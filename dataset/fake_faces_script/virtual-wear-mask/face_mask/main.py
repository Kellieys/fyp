...
pic_dir = r"C:\\Users\\User\\Desktop\\virtual-wear-mask\\images\\without_mask_default"
# path of the folder that will contain the modified image
outPath =r"C:\Users\User\Desktop\virtual-wear-mask\images\with_mask"
...
def cli():
    ...
    # parser.add_argument('pic_dir', help="Picture directory.")
    ...
    group.add_argument('--white', action='store_true', help='Wear white mask')
    args = parser.parse_args()

    # pic_dir = args.pic_dir
    # if not os.path.exists(args.pic_dir):
    if not os.path.exists(pic_dir):
        print(f'Picture {pic_dir} not exists.')
        sys.exit(1)
    ...
    for pic in os.listdir(pic_dir):
        ...
        # print(args.show)
        # print(args.model)
        # FaceMasker(pic, mask_path, args.show, args.model).mask()   
        # FaceMasker(r"C:\Users\User\Desktop\virtual-wear-mask\images\without_mask\\" + pic, mask_path, args.show, args.model).mask()  
        FaceMasker(r"C:\Users\User\Desktop\virtual-wear-mask\images\without_mask_default\\" + pic, mask_path, args.show, args.model).mask()    
...
class FaceMasker:
    ...
    def _save(self):
        ...
        saveFolder = r"C:\Users\User\Desktop\virtual-wear-mask\images\with_mask\\"
        test = path_splits[0].replace("C:\\Users\\User\\Desktop\\virtual-wear-mask\\images\\without_mask_default\\","")
        test = test.replace("\\","")

        new_face_path = saveFolder + test + '-with-mask' + path_splits[1]
        self._face_img.save(new_face_path)
