...
prototxtPath = r"opencv_facedetector\deploy.prototxt"
weightsPath = r"opencv_facedetector\res10_300x300_ssd_iter_140000.caffemodel"
predictFace = cv2.dnn.readNet(prototxtPath, weightsPath)

# load in the face mask model that was traiend 
predictMask = load_model(r"trained_model\Real-person-dataset-model.model")
